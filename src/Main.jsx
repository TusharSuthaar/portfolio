  ...
  return (
    ...
    className='Main' id="mainy">
      <div className="main_left">
        ...
        <h2 className='names'>Tushar Suthar</h2>
        <p className='i_am_a'>I am a&nbsp;<span class="typewriter"></span></p>
        
        <div className="flex1">
        <p className='follow_me'>follow me: </p>
        <div className="logos">
        <a href="www.linkedin.com/in/tusharsuthar0511"><img src={codechef} alt="www.linkedin.com/in/tusharsuthar0511" /></a>
        ...
        <div className="flex1">
        <a href="mailto:tusharsuthaar@gmail.com"><button className='buttonc'>E-Mail Me</button></a>
        <button onClick={() => window.open("https://drive.google.com/file/d/1AUKxVQer9Cp9pCHYQQsmvtDSwKBdHJha/view?usp=sharing", "_blank")} className='buttonb'>Resume</button>
        </div>
      </div>
